...
// Just doing a simple replace since they are identical structure
...
// We can find them by the comments.
...
// Next section starts at {/* Custom Request */} or something? Let's check what's after Jump Start.
// Wait, looking at the previous cat, it's `</div>\n              <div className="mt-16 text-center">`
...
console.log("Reordered Jump Start Service");
