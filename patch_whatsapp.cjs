...
const whatsappOriginal = `{/* WHATSAPP */}
      <a 
        ...
        className="fixed right-5 bottom-5 w-[58px] h-[58px] bg-[#25d366] text-white rounded-full flex items-center justify-center z-50 shadow-[0_5px_25px_rgba(0,0,0,0.4)] no-underline transition-transform hover:scale-110"
        aria-label="WhatsApp"
      >
...
const miniBarStr = `{/* QUICK CONTACT MINI-BAR */}
...
content = content.replace(whatsappOriginal, miniBarStr);
