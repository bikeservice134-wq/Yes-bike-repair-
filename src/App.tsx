...
import { 
  ...
  Phone, User, Smartphone, Settings, Bike, X, ArrowRight, Instagram, Facebook, Twitter, Sun, Moon, Map
} from 'lucide-react';
          ...
          <section id="pricing" className="py-24 px-5 bg-gray-50 dark:bg-[#0f0f0f] border-t border-gray-100 dark:border-[#222]">
            <FadeIn>
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                  <h2 className="text-[36px] md:text-[40px] font-bold mb-4 leading-tight text-gray-900 dark:text-white">
                    Transparent <span className="text-yellow-500 dark:text-yellow-400">Pricing</span>
                  </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="bg-white dark:bg-[#1a1a1a] rounded-[24px] border border-gray-200 dark:border-[#333] p-8 flex flex-col shadow-sm hover:shadow-xl transition-all duration-300 relative group">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">General Service</h3>
                    <div className="text-3xl font-black text-yellow-600 dark:text-yellow-500 mb-6">₹699</div>
                    <ul className="space-y-4 mb-8 flex-1">
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Water Wash & Polish</li>
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Oil Filter Check</li>
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Brake Adjustments</li>
                    </ul>
                    <button onClick={() => { setSelectedPackage({name: 'General Service', price: '₹699'}); setIsPackageModalOpen(true); }} className="w-full bg-gray-100 dark:bg-[#2a2a2a] hover:bg-yellow-500 dark:hover:bg-yellow-500 text-gray-900 dark:text-white hover:text-black px-4 py-3 rounded-xl font-bold transition-colors">Select Package</button>
                  </div>
                  ...
                  <div className="bg-gray-900 dark:bg-[#161616] rounded-[24px] border-2 border-yellow-500 p-8 flex flex-col shadow-[0_8px_30px_rgba(234,179,8,0.15)] relative transform md:-translate-y-2">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">Service + Engine Oil</h3>
                    <div className="text-3xl font-black text-yellow-400 mb-6">₹1,249</div>
                    <ul className="space-y-4 mb-8 flex-1">
                      <li className="flex items-start gap-3 text-sm text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-400 shrink-0" /> General Service Included</li>
                      <li className="flex items-start gap-3 text-sm text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-400 shrink-0" /> Motul Premium Oil Change</li>
                      <li className="flex items-start gap-3 text-sm text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-400 shrink-0" /> Chain Lube & Adjustment</li>
                      <li className="flex items-start gap-3 text-sm text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-400 shrink-0" /> 1 Month Warranty</li>
                    </ul>
                    <button onClick={() => { setSelectedPackage({name: 'Service + Engine Oil', price: '₹1,249'}); setIsPackageModalOpen(true); }} className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-300 hover:to-yellow-400 text-black px-4 py-3 rounded-xl font-bold transition-all hover:scale-[1.02]">Select Package</button>
                  </div>
                  
                  {/* Pkg 3 */}
                  <div className="bg-white dark:bg-[#1a1a1a] rounded-[24px] border border-gray-200 dark:border-[#333] p-8 flex flex-col shadow-sm hover:shadow-xl transition-all duration-300 relative group">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Jump Start</h3>
                    <div className="text-3xl font-black text-yellow-600 dark:text-yellow-500 mb-6">₹399</div>
                    <ul className="space-y-4 mb-8 flex-1">
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Rapid Doorstep Arrival</li>
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Battery Health Check</li>
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Minor Electrical Fix</li>
                    </ul>
                    <button onClick={() => { setSelectedPackage({name: 'Jump Start', price: '₹399'}); setIsPackageModalOpen(true); }} className="w-full bg-gray-100 dark:bg-[#2a2a2a] hover:bg-yellow-500 dark:hover:bg-yellow-500 text-gray-900 dark:text-white hover:text-black px-4 py-3 rounded-xl font-bold transition-colors">Select Package</button>
                  </div>
                  
                  {/* Pkg 4 */}
                  <div className="bg-white dark:bg-[#1a1a1a] rounded-[24px] border border-gray-200 dark:border-[#333] p-8 flex flex-col shadow-sm hover:shadow-xl transition-all duration-300 relative group">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Puncture Repair</h3>
                    <div className="text-3xl font-black text-yellow-600 dark:text-yellow-500 mb-6">₹599</div>
                    <ul className="space-y-4 mb-8 flex-1">
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Tubeless Puncture Fix</li>
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Air Pressure Check</li>
                      <li className="flex items-start gap-3 text-sm text-gray-700 dark:text-gray-300 font-medium"><CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> Wheel Alignment Basics</li>
                    </ul>
                    <button onClick={() => { setSelectedPackage({name: 'Puncture Repair', price: '₹599'}); setIsPackageModalOpen(true); }} className="w-full bg-gray-100 dark:bg-[#2a2a2a] hover:bg-yellow-500 dark:hover:bg-yellow-500 text-gray-900 dark:text-white hover:text-black px-4 py-3 rounded-xl font-bold transition-colors">Select Package</button>
                  </div>
                </div>
              </div>
            </FadeIn>
